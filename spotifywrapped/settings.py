...
SESSION_ENGINE = "django.contrib.sessions.backends.db"  # Default: store in database
...
SECRET_KEY = 'django-insecure-)e7!ps#nabv5q!#nzjm@l-1wyuiv0e$))o#)qzy8z0s*07o3^='
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv("db.cctzoiblaekanfklinnn.supabase.co"),
        'PORT': '5432',
    }
}
